...
#      'jdshop_id': '京东店铺ID','item_id': '商品ID','item_commit_number': '商品评论数','商品url':'itemURL'})
...
for page in range(page_start, page_end):
    ...
    for i in range(1, 61):
        try:
            ...
            #商品图片url
            ##mainList-layer-100005485240 > img
            #document.querySelector("#mainList-layer-100005485240 > img")
            ##mainList-layer-100005485240 > img
            ##J_goodsList > ul > li:nth-child(2) > div > div.p-img > a > img
            itemURL = browser.find_element(By.CSS_SELECTOR,
                                                      f'#J_goodsList > ul > li:nth-child({i}) > div > div.p-img > a > img').text
            csvWriter.writerow(
